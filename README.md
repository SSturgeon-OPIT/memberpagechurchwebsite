...
### In the repository will be: > HTML code > CSS code > JS file (no code as yet) > GitHub > Originally Replit, but switched to VS Code, and will be using VS Code for the remainder of the project ###

#### This project was created for the OPIT COMP 2002 Web Development Course. It follows the following important dates as guidelines for its progress: > 11th of February - Assessment 1 - > 25th of March - Assessment 2 - > 7th of April - Assessment 3 - ####
